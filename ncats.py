...
# --- Auto-copiado ---
# Copia las imágenes test_cat_#.png a predict/cat o predict/nocat según probabilidad

for i in range(len(predictions)):
    prob = predictions[i][0]
    nombre = f"test_cat_{i+1}.png"
    origen = f"dataset/test/{nombre}"
    if prob >= 0.5:
        destino = f"dataset/predict/cat/{nombre}"
    else:
        destino = f"dataset/predict/nocat/{nombre}"
    try:
...
print("Las imágenes fueron copiadas automáticamente.")
# --- Fin ---
